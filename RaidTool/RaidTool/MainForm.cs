...
namespace RaidTool
{
    public partial class MainForm : Form
    {
        ...
        private ChangeAvatar avatar = new ChangeAvatar();
        private DMSpammer dmSpam = new DMSpammer();
        private EmbedSpammer embedSpam = new EmbedSpammer();
        private Friender friender = new Friender();
        private JoinLeaveSpammer joinLeave = new JoinLeaveSpammer();
        private MessageSpammer msgSpam = new MessageSpammer();
        private TokenChecker tokenCkr = new TokenChecker();
        private VoiceSpammer voiceSpam = new VoiceSpammer();
